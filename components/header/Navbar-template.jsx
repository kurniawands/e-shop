...
//           <div
//             key={item.name}
//             className="flex flex-row text-center mx-10 my-10 bg-gray-600 border"
//           >
//             <div className="w-full border">
//               <Image
//                 className="mx-auto my-5 border"
//                 src={item.img}
//                 width={300}
//                 height={300}
//               />
...
//               <p className="w-52 my-auto text-3xl bg-red-900 font-medium p-2 border">
//                 {item.name}
//               </p>
