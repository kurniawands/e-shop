...
export default function Footer() {
  ...
  return (
    <>
      <div className="max-w-7xl flex flex-col w-full h-[512px] mx-auto py-14 justify-between bg-custom-4 bg-opacity-20">
        ...
        <div className="flex flex-row h-56 mx-12 justify-between">
          <div className="flex flex-col justify-between w-60 h-full">
            ...
            <div className="flex flex-row h-12 items-end space-x-5 border-t">
              {contact.map((item) => (
                <Image key={item.name} src={item.src} width={24} height={24} />
              ))}
            </div>
          </div>
